...
TOKEN_NUMS = 3000000
RATIO = 1.0
EN_DATA_DIR = "/tmp/code/results/result_en.jsonl"
ZH_DATA_DIR = "/tmp/code/results/result_zh.jsonl"
OUTPUT_FILES = "/tmp/code/results/sample1b.jsonl"
...
enc = AutoTokenizer.from_pretrained("/tmp/code/competition_kit/data/models/falcon-rw-1b")
